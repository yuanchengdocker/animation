    ...
    h.classes.Widget = function(k, t, u) {
        ...
        ab.show = function(c, d) {
            ...
            function(a) {
                ...
                this.disabled || a(this).addClass("dwtd").prop("disabled", !1)
...
function(a, b) {
    ...
    e = function(c) {
        ...
        G = i(F, y);
        return a("#" + x).remove(),
        s.showInput && (p = a('<input type="text" id="' + x + '" value="" class="' + s.inputClass + '" placeholder="' + (s.placeholder || "") + '" readonly style="opacity:0;position:absolute;bottom:-7rem;z-index:-1;"/>').insertBefore(w), s.anchor = p, c.attachShow(p)),
